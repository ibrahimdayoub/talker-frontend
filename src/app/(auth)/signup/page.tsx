        ...
        <div className="relative min-h-screen p-5 flex items-center justify-center bg-white dark:bg-[#0f172a] transition-colors duration-300">
            ...
            <div className="relative w-full max-w-md p-5 sm:px-10 sm:py-7.5 space-y-10 bg-white dark:bg-slate-900 shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] rounded-3xl border border-slate-200 dark:border-slate-800">
                ...
                <div className="flex flex-col gap-1.25 items-center text-center">
                    ...
                    <p className="text-slate-600 dark:text-slate-400">Connect with people who matter and start your conversation today!</p>
                </div>
                {/* Form */}
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div className="space-y-2.5">
                        <label className="flex items-center gap-2.5 text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest ml-1.25">
                            <User size={15} className="text-orange-600" /> User Name
                        </label>
                        <input
                            {...register("username")}
                            type="text"
                    ...
                    <div className="flex justify-between">
                        <span className="flex items-center gap-2.5 text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest ml-1.25">
                            <Sparkles size={15} className="text-purple-600" /> Registered?
                        </span>
                        <Link href="/signin" className="text-purple-600 dark:text-purple-400 text-sm font-bold hover:text-orange-600 dark:hover:text-orange-400 transition-all underline underline-offset-2">
                            Sign In Here
                        </Link>
                    </div>
                    {/* Submit Button */}
                    <button
                        ...
                        className={cn(
                            "w-full py-2.5 flex items-center justify-center gap-2.5 text-white font-bold text-lg tracking-wider rounded-xl shadow-xl shadow-purple-600/25 transform transition-all active:scale-95",
                            isSigningUp
